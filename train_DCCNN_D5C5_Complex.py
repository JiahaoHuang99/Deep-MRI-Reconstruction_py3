...
def create_dummy_data(data_path_train, data_path_val, data_path_test, h, w):
    ...
    train_data_array = load_images(data_path_train, h, w)
    val_data_array = load_images(data_path_val, h, w)
    test_data_array = load_images(data_path_test, h, w)

    return train_data_array, val_data_array, test_data_array
...
if __name__ == '__main__':
    ...
    # Create dataset
    train, validate, test = create_dummy_data(data_path_train,
                                              data_path_val,
                                              data_path_test,
                                              Nx,
                                              Ny)
